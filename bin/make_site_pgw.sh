...
outDir="/glade/derecho/scratch/meghan/Roza/masks/PGW/${region}"
...
function mask_region_year_month(){
    ...
    year=$1
    month=$2
    varNames="AS_LWC,AS_Tc,AS_U,AS_V,GS_LWC,GS_Tc,GS_U,GS_V,GS_LWC2,GS_Tc2,GS_U2,GS_V2,Tc_250MB,U_250MB,V_250MB,Z_250MB,Tc_500MB,U_500MB,V_500MB,Z_500MB,Tc_700MB,U_700MB,V_700MB,Z_700MB,Tc_850MB,U_850MB,V_850MB,Z_850MB"
    vars=("AS_LWC" "AS_Tc" "AS_U" "AS_V" "GS_LWC" "GS_Tc" "GS_U" "GS_V" "GS_LWC2" "GS_Tc2" "GS_U2" "GS_V2" "Tc_250MB" "U_250MB" "V_250MB" "Z_250MB" "Tc_500MB" "U_500MB" "V_500MB" "Z_500MB" "Tc_700MB" "U_700MB" "V_700MB" "Z_700MB" "Tc_850MB" "U_850MB" "V_850MB" "Z_850MB")
