...
/glade/derecho/scratch/meghan/Roza/roza/bin/run_sv_calcs.sh ${YEAR} ${MONTH}

#----------------------------------------------------------------------------------
# qsub -v YEAR=1979 ./bin/submit_sv_calcs.sh
#
# for year in `seq 1980 2022`; do qsub -v YEAR=${year} ./bin/submit_sv_calcs.sh ; done
#----------------------------------------------------------------------------------
