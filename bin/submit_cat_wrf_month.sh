...
./bin/cat_wrf_files_month.sh ${MONTH}

#----------------------------------------------------------------------------------
# qsub -v MONTH=11 ./bin/submit_cat_wrf_month.sh
#
# for month in "11" "12" "01" "02" "03" "04"; do qsub -v MONTH=${month} ./bin/submit_cat_wrf_month.sh ; done
#----------------------------------------------------------------------------------
