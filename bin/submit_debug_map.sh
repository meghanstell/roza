...
COLUMNS=200 /glade/work/meghan/miniforge3/envs/dorn/bin/python -u bin/create_maps.py --sv-file /glade/derecho/scratch/meghan/Roza/data/CONUS404/cat/monthly/SV_2022_09.nc cool --all
