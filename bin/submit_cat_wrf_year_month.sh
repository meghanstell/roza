...
./bin/cat_wrf_files_year_month.sh ${YEAR} ${MONTH}

#----------------------------------------------------------------------------------
# qsub -v YEAR=1979 ./bin/submit_cat_wrf_year_month.sh
#
# for year in `seq 1979 2022`; do qsub -v YEAR=${year} ./bin/submit_cat_wrf_year_month.sh ; done
#----------------------------------------------------------------------------------
