...
COLUMNS=200 /glade/work/meghan/miniforge3/envs/dorn/bin/python -u bin/create_maps.py --sv-file /glade/campaign/ral/hap/meghan/Roza/data/CONUS404/cat/SV_Season.nc cool --all
