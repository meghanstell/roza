...
#PBS -N RzSM
#PBS -A P48500028
#PBS -l select=1:ncpus=2:mem=75GB
...
COLUMNS=200 /glade/work/meghan/miniforge3/envs/dorn/bin/python -u bin/create_maps.py \
    --sv-file /glade/campaign/ral/hap/meghan/Roza/data/PGW/cat/SV_Season.nc \
    --dom-file /glade/campaign/ral/hap/meghan/Roza/data/PGW/wrfconstants_pgw_roza.nc \
    cool \
        --model PGW \
        --all

#----------------------------------------------------------------------------------
# qsub ./bin/submit_season_maps_pgw.sh
#----------------------------------------------------------------------------------
