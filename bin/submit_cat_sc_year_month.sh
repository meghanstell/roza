...
/glade/derecho/scratch/meghan/Roza/roza/bin/cat_sc_files_year_month.sh ${YEAR} ${MONTH}

#----------------------------------------------------------------------------------
# qsub -v YEAR=2018 ./bin/submit_cat_sc_year_month.sh
#
# for year in `seq 1979 2022`; do qsub -v YEAR=${year} ./bin/submit_cat_sc_year_month.sh ; done
#----------------------------------------------------------------------------------
