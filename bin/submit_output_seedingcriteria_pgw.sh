...
/glade/derecho/scratch/meghan/Roza/roza/bin/make_3d_analysis_files_roza_pgw.sh ${YEAR} ${MONTH}

#----------------------------------------------------------------------------------
# qsub -v YEAR=1979 ./bin/submit_output_seedingcriteria_pgw.sh
#
# for year in `seq 1980 2022`; do
#     qsub -v YEAR=${year} ./bin/submit_output_seedingcriteria_pgw.sh
# done
#----------------------------------------------------------------------------------
