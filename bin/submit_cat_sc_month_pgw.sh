...
./bin/cat_sc_files_month_pgw.sh ${MONTH}

#----------------------------------------------------------------------------------
# qsub -v MONTH=11 ./bin/submit_cat_sc_month_pgw.sh
#
# for month in "11" "12" "01" "02" "03" "04"; do qsub -v MONTH=${month} ./bin/submit_cat_sc_month_pgw.sh ; done
#----------------------------------------------------------------------------------
