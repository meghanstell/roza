...
COLUMNS=200 /glade/work/meghan/miniforge3/envs/dorn/bin/python -u bin/create_maps.py --sv-file /glade/derecho/scratch/meghan/Roza/data/CONUS404/cat/SV_${month}.nc wind --mb250 --mb500 --mb700 --mb850 --avg
