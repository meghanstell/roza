...
./bin/cat_sc_files_year_month_pgw.sh ${YEAR} ${MONTH}

#----------------------------------------------------------------------------------
# qsub -v YEAR=2018 ./bin/submit_cat_sc_year_month_pgw.sh
#
# for year in `seq 1979 2022`; do qsub -v YEAR=${year} ./bin/submit_cat_sc_year_month_pgw.sh ; done
#----------------------------------------------------------------------------------
